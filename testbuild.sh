...
if [ "$1" ]; then
	...
	scp -P $PORT target/cranix-16.0.jar root@$1:/opt/cranix-java/lib/cranix.jar
...
mv    target/cranix-16.0.jar        cranix-java/lib/cranix.jar
...
./adapt-roles.pl >  ${HERE}/cranix-java/data/updates/adapt-roles.sh
